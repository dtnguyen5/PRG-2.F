...
public class arrays_playlist {
    public static void main(String[] args) {
        ...
        //            System.out.println("Song: " + songs[index] + "hodnocení: " + ratings[index]);
        //        }
        // vypsani jedno songy
...
//        }
        ...
        String [] vetsiSongy = new String[songs.length * 2];
        double [] vetsiRating = new double[ratings.length * 2];

        for (int i = 0; i < songs.length; i++) {
            vetsiSongy[i] = songs[i];
            vetsiRating[i] = ratings[i];
        }

        // vezmu odkaz na tu pamet a nacpe to do toho songs
        songs = vetsiSongy;
        ratings = vetsiRating;
